...
class WorkspaceContractSummary:
    ...
    layout: WorkspaceContractLayout = field(
        default_factory=WorkspaceContractLayout)

    def __post_init__(self) -> None:
        object.__setattr__(self, "shared_rule_paths",
                           self._sorted_paths(self.shared_rule_paths))
        object.__setattr__(self, "missing_shared_rule_paths",
                           self._sorted_paths(self.missing_shared_rule_paths))
        object.__setattr__(self, "override_paths",
                           self._sorted_paths(self.override_paths))
        object.__setattr__(self, "project_specific_paths",
                           self._sorted_paths(self.project_specific_paths))
