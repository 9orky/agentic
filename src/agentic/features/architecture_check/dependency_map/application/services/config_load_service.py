...
def build_default_config_load_service() -> ConfigLoadService:
    return ConfigLoadService(config_loader=ConfigLoader())


__all__ = ["ConfigLoadService", "build_default_config_load_service"]