...
class ExtractorSpecRegistry:
    def __init__(self) -> None:
        self._extractor_specs: dict[str, ExtractorSpec] = {
            "python": ExtractorSpec(command=sys.executable, resource_name="python_extractor.py"),
            "typescript": ExtractorSpec(command="node", resource_name="typescript_extractor.js"),
            "php": ExtractorSpec(command="php", resource_name="php_extractor.php"),
        }
