...
from ....dependency_map.application import BuildDependencyMapQuery, DependencyMapBuildError
from ....dependency_map.application.services.config_load_service import ConfigLoadService, build_default_config_load_service
from ....dependency_map.application.services.dependency_map_builder import DependencyGraphBuilder, DependencyMapBuilder
from ....dependency_map.domain import ArchitectureCheckConfigError, CheckerError
from ....dependency_map.infrastructure import ExtractorRuntime, ExtractorRuntimeFactory, ExtractorSpecRegistry
...
class FileImportHotspotsService:
    def __init__(
        ...
        *,
        ...
        self._build_dependency_map_query = BuildDependencyMapQuery(
            dependency_map_builder=DependencyMapBuilder(
                config_load_service=config_load_service,
                extractor_runtime_factory=extractor_runtime_factory,
                extractor_spec_registry=extractor_spec_registry,
    ...
    def describe(
        ...
        *,
        ...
        tracked_files = set(dependency_map_result.extraction_result.files.keys())
