...
This file is part of the durable `agentic/` collaboration contract, so test guidance here should help future runs verify behavior through the same public seams.
